...
int Window::screen_exit = 0;
int Window::screen_keys[512];

int Window::screen_init(int w, int h, const char * title)
{
...
LRESULT Window::screen_events(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam) {
	switch (msg) {
...
void Window::screen_update(void) {
	//auto hc = LoadCursor(NULL, IDC_CROSS);
	//SetCursor(hc);
